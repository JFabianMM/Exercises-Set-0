...
// This is simplified expresion with NO "with statements"
  base=myLib.math.real;
  answer= base.sub(base.add(20, 22),base.mul(2,5));
 console.log(answer)
...
// let answer= matrix.times(matrix.eye(4),complex.sub(complex.Num(real.add(5,2),-3),complex.Num(3,4)));
