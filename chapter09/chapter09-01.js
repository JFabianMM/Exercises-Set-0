...
let str = '{"prop1": 42, "prop2": 50, "myFn": function(a, b) { return a+b+this.prop1;}}';
let str2 = '{"prop1":42, "prop2":64}';
let str3 = "{prop1: 42, myFn: function(a, b) { return a+b+this.prop1;}}"
let str4 = '{"a": "function"}'

let data = dataParse(str);  
console.log(data);
