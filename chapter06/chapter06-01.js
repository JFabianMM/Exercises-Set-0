...
let equilaterial = new Triangle('equilateral', 5, 5, 5);      // Is created by the Triangle constructor
let equilaterial2 = equilaterial.clone('equilateral2', 7, 7, 7);   // Is created and instance of Trianglre
...
let square = new Quadrilateral('square', 5, 5, 5, 5 );
let square2 = square.clone('square2', 8, 8, 8, 8 );
...
// Now I create a new subtype of square (isosceles trapezium)
function Trapezium(name, sideB, sideb, lateralSide1, lateralSide2) {   // lateralSides must be the same for isosceles trapeziums        
  Quadrilateral.call(this, name);
  this.category=Trapezium;
  this.side1=sideB;
  this.side2=sideb;
  this.side3=lateralSide1;
  this.side4=lateralSide2;
}
Trapezium.prototype = Object.create(Quadrilateral.prototype);     // Is copied the prototype
Trapezium.prototype.constructor = Trapezium;                      // The constructor is changed
Trapezium.prototype.area = function() {                           // The method area is added
  let triangleBase= (this.side1-this.side2)/2;                    // Lateral triangle base to get the hight
  let hight= Math.sqrt((this.side3 * this.side3) - (triangleBase * triangleBase));    // h is obtained                           
  let area=(this.side1 + this.side2)/2 * hight;                       
  return area;
}

let trapezium1 = new Trapezium('trapezium1', 16, 8, 8, 8);
console.log(trapezium1 instanceof Quadrilateral)
console.log(trapezium1.getName())
console.log(trapezium1.side1)
console.log(trapezium1.side2)
console.log(trapezium1.side3)
console.log(trapezium1.area())
console.log(trapezium1.perimeter())
...
function Employee(first_name,last_name, age) {      
...
let engineer1 = new Engineer('Jesus', 'Mendoza', 29, 1000);      // Is created by the Engineer constructor
let chemical_eng1 = engineer1.clone('Jose', 'Smith', 55, 2000);      // Is created and instance of Engineer
...
let worker1 = new Laborer('Josue', 'Ortiz', 30, 500, 400);      // Is created by the Laborer constructor
let worker2 = worker1.clone('Alma', 'Castro', 50, 500, 900);    // Is created and instance of Engineer
